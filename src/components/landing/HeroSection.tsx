        ...
        <div className="mb-12 sm:mb-16">
          <div className="text-3xl sm:text-4xl md:text-6xl font-bold text-center">
            ...
            <div className="leading-tight">
              ...
              <span className="font-instrument text-black font-bold italic whitespace-nowrap text-4xl sm:text-5xl md:text-7xl my-2">Mobile&nbsp;Money</span>
            </div>
          </div>
        </div>
        
        <p className="text-sm sm:text-lg md:text-xl text-gray-700 mb-12 sm:mb-16 max-w-2xl mx-auto font-inter px-2 sm:px-4">
